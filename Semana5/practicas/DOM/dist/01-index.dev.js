...
var lista = document.getElementById('lista'); // creamos un Array

var arrayElement = ['primero', 'segundo', 'tercero']; // creamos la función

arrayElement.forEach(function (item) {
  //creamos un nuevo elemento
  var li = document.createElement('li'); // agregamos con esto texto

  li.innerHTML = item; //agregando un documentp hijo 
