...
if (unidades >= 1000) {
  ...
  console.log("total a pagar: ".concat(unidades * 0.85));
} else {
  console.log("precio por producto: 0.90 centavos");
  console.log("total a pagar: ".concat(unidades * 0.90));
...
if (unidades2 >= 2500) {
  ...
  console.log("total a pagar: ".concat(unidades2 * 0.85));
} else {
  console.log("tienes un descuento del 8%");
  console.log("total a pagar: ".concat(unidades2 * 0.92));
}
/**
 * ESPACIO TEÓRICO
