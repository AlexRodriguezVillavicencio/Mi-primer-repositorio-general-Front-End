...
var c1 = 0,
    ...
    c4 = 0,
    promedio = 0,
    suma = 0; //LEYENDO LOS NUMEROS QUE PONEN EL USUARIO
...
c4 = +prompt("ingrese la cuarta nota: "); //como mostrar  el tipo de dato de una variable?
...
console.log('el promedio es: ${promedio} '); //hacer los ejercicios del 1 al 23 del libro de algoritmos, pagina 43